...
while True: #while adalah sebuah fungsi perulangan tidak ada limitnya klo ndak dikasi fungsi break cmiiw
    try:
        print("**********************************************#ASMARAKACAU") #cetak
        print("**************Jatim SpeedShop*****************#ANTASARI RACEWAY") #cetak
        print("**********************************************#PASUKANGHOIB") #cetak
        print("Toko Part Recink Yang Membuat Motor Anda Hedon#PLATKTBERDUKA") #cetak
        print("**********************************************#NR") #cetak
        print("******************PLAT KT*********************#KIRIANSTD") #cetak
                ...
                while True: # ada diatas penjelasannya
                    try:
                        if multiuser[user]['privilage'] == 'admin': #jika data sesuai yg ditaro di variabel multiuser yang menyimpan data user dan privilage dengan yang diinputkan di fungsi sign in, maka berhasil masokk
                            ...
                            elif user_choice == '5': #kalo milih 5
                                simpan_data() #buat nyimpen data
                        ...
                        elif multiuser[user]['privilage'] == 'pembeli': #kalo privilage nya pembeli masuk menu ini CMIIW
                            ...
                            if user_choice == '1': #memanggil fungsi recharge_e_money
                                recharge_e_money(user) #manggil fungsi e-money berupa cek saldo sama nambah saldo
                                
                                
                            elif user_choice == '2': #memanggil fungsi beli_part
                                beli_part(user) #manggil fungsi buat beli part recingg
                                
                            elif user_choice == '3': #memanggil fungsi melihat_invoice
                                melihat_invoice(user) #manggil fungsi ngeliat barang yang habis dibeli
                                
                            elif user_choice == '4': #berhenti dengan fungsi break
                                simpan_data() #manggil fungsi nyimpan data
                            ...
                            print("========================================================================")
                            print("SALAH KETIK MASSEH PRIVILAGENYA. CUMAN BISA ADMIN SAMA PEMBELI DOANG : )")  #cetak ini
                            print("========================================================================")
                            break #biar stop
                    except KeyboardInterrupt:
                        print("=====")
